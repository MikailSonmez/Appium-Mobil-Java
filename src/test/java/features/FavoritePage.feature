...
Feature: Favorite Page
  ...
  Scenario Outline:  Empty Favorite Tab
    ...
    Examples:
      ...
      | mikail.erdgn32@gmail.com | mikail.1995 | Favorilerim | Favori restoranınız bulunamadı |
  ...
  Scenario Outline:  Empty Favorite Page
    ...
    Examples:
      ...
      | mikail.erdgn32@gmail.com | mikail.1995 | Favorilerim | Henüz favori restoranınız bulunmamaktadır. |
  ...
  Scenario Outline:  Add Favorite Restaurant
    ...
    Examples:
      ...
      | mikail.erdgn32@gmail.com | mikail.1995 | Favorilerim | Süper Restoranlar | Ahmet Usta'nın Yeri |
  ...
  Scenario Outline:  Delete Favorite Restaurant
    ...
    Examples:
      ...
      | mikail.erdgn32@gmail.com | mikail.1995 | Favorilerim | Ahmet Usta'nın Yeri | Henüz favori restoranınız bulunmamaktadır. |
